    ...
    <div class="biz-main">
        ...
        <header class="biz-topbar">
            <div class="d-flex align-items-center gap-3">
                ...
                <h1 class="biz-page-title">Admin Management</h1>
            </div>
                    ...
                    <div class="biz-table-wrapper">
                        <table class="biz-table">
                            <thead>
                                <tr>
                                    <th>
                                        <a href="{{ route('admin.manage_admin', array_merge(request()->query(), ['sort' => 'firstname', 'dir' => request('sort') === 'firstname' && request('dir') === 'asc' ? 'desc' : 'asc'])) }}" style="color: inherit; text-decoration: none;">
                                            User
                                    ...
                                    <th>
                                        <a href="{{ route('admin.manage_admin', array_merge(request()->query(), ['sort' => 'role', 'dir' => request('sort') === 'role' && request('dir') === 'asc' ? 'desc' : 'asc'])) }}" style="color: inherit; text-decoration: none;">
                                            Role
                                    ...
                                    <th>
                                        <a href="{{ route('admin.manage_admin', array_merge(request()->query(), ['sort' => 'status', 'dir' => request('sort') === 'status' && request('dir') === 'asc' ? 'desc' : 'asc'])) }}" style="color: inherit; text-decoration: none;">
                                            Status
                                    ...
                                    <th>
                                        <a href="{{ route('admin.manage_admin', array_merge(request()->query(), ['sort' => 'email_verified_at', 'dir' => request('sort') === 'email_verified_at' && request('dir') === 'asc' ? 'desc' : 'asc'])) }}" style="color: inherit; text-decoration: none;">
                                            Verified
                                    ...
                                    <th>
                                        <a href="{{ route('admin.manage_admin', array_merge(request()->query(), ['sort' => 'created_at', 'dir' => request('sort') === 'created_at' && request('dir') === 'asc' ? 'desc' : 'asc'])) }}" style="color: inherit; text-decoration: none;">
                                            Joined
                                    ...
                                    <tr>
                                        <td>
                                            <div class="biz-table-user">
                                                ...
                                                <div>
                                                    <div class="biz-user-name">{{ $admin->firstname }} {{ $admin->lastname }}</div>
                                                    <div class="biz-user-email">{{ $admin->email }}</div>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="biz-role-badge
                                                ...
                                                @elseif($admin->role === 'admin')
                                                    biz-role-admin
                                                @elseif($admin->role === 'business_owner')
                                        ...
                                        <td style="text-align: center;">
                                            <div class="biz-action-group" style="justify-content: center;">
                                                <!-- Toggle Status -->
                                                <form method="POST" action="{{ route('admin.users.toggle-status', $admin->id) }}" class="d-inline" onsubmit="return confirmToggleStatus('{{ $admin->firstname }} {{ $admin->lastname }}', '{{ $admin->status }}')">
                                                    @csrf
                                                    @method('PATCH')
                                                    @if($admin->status === 'active')
                                                ...
                                                @if($admin->id !== Auth::id())
                                                    <button type="button" class="biz-action-btn biz-action-danger" title="Delete User"
                                                            onclick="openDeleteModal({{ $admin->id }}, '{{ $admin->firstname }} {{ $admin->lastname }}')">
        ...
        <div class="biz-card">
            ...
            <div class="biz-card-body">
                 ...
                 <!-- Table -->
                @if($users->count() > 0)
                    <div class="biz-table-wrapper mt-4">
                        <table class="biz-table">
                            <thead>
                                <tr>
                                    <th>
